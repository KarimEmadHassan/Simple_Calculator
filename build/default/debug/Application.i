...
# 12 "./ECU_Layer/LED/../../MCAL_Layer/GPIO/../Std_Libiraries.h"
...
# 1 "./ECU_Layer/LED/../../MCAL_Layer/GPIO/../Compilar.h" 1
# 12 "./ECU_Layer/LED/../../MCAL_Layer/GPIO/../Compilar.h"
...
# 12 "./ECU_Layer/LED/../../MCAL_Layer/GPIO/../Compilar.h" 2
...
# 19 "./ECU_Layer/Push_Button/ECU_Push_Button.h"
typedef enum {
    BUTTON_PRESSED=0,
    BUTTON_NOT_PRESSED
}button_status_t;
...
Std_ReturnType Button_Init (const button_config_t *button);
Std_ReturnType Button_Read (const button_config_t *button , button_status_t *status);
# 13 "./Application.h" 2
...
Std_ReturnType RELAY_Init (const relay_config_t *relay);
Std_ReturnType RELAY_Turn_ON (const relay_config_t *relay);
Std_ReturnType RELAY_Turn_OFF (const relay_config_t *relay);
Std_ReturnType RELAY_Toggle (const relay_config_t *relay);
# 14 "./Application.h" 2

# 1 "./ECU_Layer/DC_Motor/DC_Motor.h" 1
# 20 "./ECU_Layer/DC_Motor/DC_Motor.h"
typedef struct {
    pin_config_t dc_motor[2];
}motor_pin_t;


Std_ReturnType DC_MOTOR_Init (const motor_pin_t *motor);
Std_ReturnType DC_MOTOR_Move_Right (const motor_pin_t *motor);
Std_ReturnType DC_MOTOR_Move_Left (const motor_pin_t *motor);
Std_ReturnType DC_MOTOR_Stop (const motor_pin_t *motor);
# 15 "./Application.h" 2

# 1 "./ECU_Layer/Seven_Segment/Seven_Segment.h" 1
# 20 "./ECU_Layer/Seven_Segment/Seven_Segment.h"
typedef enum {
...
typedef struct {
    ...
    segment_status_t segment_type ;
}segment_config_t;


Std_ReturnType SEGMENT_Init (const segment_config_t *segment);
Std_ReturnType SEGMENT_Write_Number (const segment_config_t *segment , uint8 number);
# 16 "./Application.h" 2
...
# 1 "./MCAL_Layer/Interrupt/INT_External.h" 1
# 12 "./MCAL_Layer/Interrupt/INT_External.h"
# 1 "./MCAL_Layer/Interrupt/INT_Config.h" 1
# 14 "./MCAL_Layer/Interrupt/INT_Config.h"
# 1 "./MCAL_Layer/Interrupt/INT_Config_Gen.h" 1
# 14 "./MCAL_Layer/Interrupt/INT_Config.h" 2
# 47 "./MCAL_Layer/Interrupt/INT_Config.h"
typedef enum {
    Low_Priorty=0,
    High_Priorty
}interrupt_priority;
# 12 "./MCAL_Layer/Interrupt/INT_External.h" 2
# 60 "./MCAL_Layer/Interrupt/INT_External.h"
typedef enum {
...
# 1 "./MCAL_Layer/ADC/ADC_Config.h" 1
# 12 "./MCAL_Layer/ADC/ADC.h" 2




# 1 "./MCAL_Layer/ADC/../Interrupt/INT_Internal.h" 1
# 16 "./MCAL_Layer/ADC/ADC.h" 2
# 70 "./MCAL_Layer/ADC/ADC.h"
typedef enum {
    ADC_CHANNEL_0 = 0,
    ADC_CHANNEL_1,
    ADC_CHANNEL_2,
...
typedef struct {
    ...
    ADC_Channel_t cahnnel;
    ADC_Acquisition_Time_t acq_time;
    ADC_Conversion_Time_t conversion_clk;
    uint8 volt_ref :1;
...
uint8 first_num[3] = {'\0' , '\0' , '\0'};
uint8 second_num[3] = {'\0' , '\0' , '\0'};
uint8 count = 0 , operator ;
    ...
    while ( count<=2 ){
            ...
            if ( first_num[count] != '\0' ){
                if ( count==0 && (first_num[0]== '=' || first_num[0]== '+' || first_num[0]== '-' || first_num[0]=='*' || first_num[0]== '/' )){
                    ...
                    ret = LCD_8BITS_Send_Command (&lcd , 0x01);
                    first_num[0] = '\0';
                    count = 0;
                }
