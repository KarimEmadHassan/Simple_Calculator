...
Std_ReturnType LED_Init (const led_config_t *led){
    ...
    pin_config_t led_config = { .DIRECTION = OUTPUT , .PORT = led->port , .PIN_NUMBER = led->pin , .LOGIC = led->status};
    if ( ((void*)0) == led ){
        RET = (Std_ReturnType)0x00 ;
    }
    else {
        RET = GPIO_PIN_Init(&led_config);
    }
    return RET;
}
...
Std_ReturnType LED_Turn_On (const led_config_t *led){
    ...
    if ( ((void*)0) == led ){
        ...
        RET = GPIO_PIN_Write_Logic(&led_config , HIGH);
    }
    return RET;
}
...
Std_ReturnType LED_Turn_Off (const led_config_t *led){
    ...
    if ( ((void*)0) == led ){
        ...
        RET = GPIO_PIN_Write_Logic(&led_config , LOW);
    }
    return RET;
}
