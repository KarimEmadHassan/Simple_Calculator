...
# 12 "ECU_Layer/LCD/../../MCAL_Layer/GPIO/../Std_Libiraries.h"
...
# 12 "ECU_Layer/LCD/../../MCAL_Layer/GPIO/../Std_Libiraries.h" 2
# 13 "ECU_Layer/LCD/../../MCAL_Layer/GPIO/../MCAL_Std_Types.h" 2

# 1 "ECU_Layer/LCD/../../MCAL_Layer/GPIO/../Compilar.h" 1
# 12 "ECU_Layer/LCD/../../MCAL_Layer/GPIO/../Compilar.h"
...
# 12 "ECU_Layer/LCD/../../MCAL_Layer/GPIO/../Compilar.h" 2
...
# 33 "ECU_Layer/LCD/../../MCAL_Layer/GPIO/HAL_GPIO.h"
typedef enum {
    LOW=0,
    HIGH
}logic_t;
...
Std_ReturnType LCD_4BITS_Send_Spcial_Char (const lcd_4bits_config_t *lcd , const uint8 my_char[] , uint8 pos , uint8 row , uint8 column){
    ...
    if ( ((void*)0) == lcd ){
        ...
        RET = LCD_4BITS_Send_Command( lcd , (0x40 + pos*8) );
...
Std_ReturnType LCD_8BITS_Init (const lcd_8bits_config_t *lcd){
    ...
    if ( ((void*)0) == lcd ){
        ...
        RET = LCD_8BITS_Send_Command((lcd) , 0x02);
        RET = LCD_8BITS_Send_Command((lcd) , 0x06);
        RET = LCD_8BITS_Send_Command((lcd) , 0x0C);
        RET = LCD_8BITS_Send_Command((lcd) , 0x38);
...
Std_ReturnType LCD_8BITS_Send_Spcial_Char (const lcd_8bits_config_t *lcd , const uint8 my_char[] , uint8 pos , uint8 row , uint8 column){
    ...
    if ( ((void*)0) == lcd ){
        ...
        RET = LCD_8BITS_Send_Command( lcd , (0x40 + pos*8) );
        for (counter=0 ; counter<8 ; counter++){
...
static Std_ReturnType LCD_4BITS_Set_CURSOR (const lcd_4bits_config_t *lcd , uint8 row , uint8 column){
    Std_ReturnType RET = (Std_ReturnType)0x01 ;
    switch ( row ){
        case 1 : RET = LCD_4BITS_Send_Command(lcd , (0x80 + column)); break;
        case 2 : RET = LCD_4BITS_Send_Command(lcd , (0xc0 + column)); break;
        case 3 : RET = LCD_4BITS_Send_Command(lcd , (0x94 + column)); break;
        case 4 : RET = LCD_4BITS_Send_Command(lcd , (0xd4 + column)); break;
        default : ;
    }
    return RET;
}
...
static Std_ReturnType LCD_8BITS_Set_CURSOR (const lcd_8bits_config_t *lcd , uint8 row , uint8 column){
    Std_ReturnType RET = (Std_ReturnType)0x01 ;
    switch ( row ){
        case 1 : RET = LCD_8BITS_Send_Command(lcd , (0x80 + column)); break;
        case 2 : RET = LCD_8BITS_Send_Command(lcd , (0xc0 + column)); break;
        case 3 : RET = LCD_8BITS_Send_Command(lcd , (0x94 + column)); break;
        case 4 : RET = LCD_8BITS_Send_Command(lcd , (0xd4 + column)); break;
        default : ;
    }
    return RET;
}
