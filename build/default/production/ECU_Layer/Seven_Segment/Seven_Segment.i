...
# 12 "ECU_Layer/Seven_Segment/../../MCAL_Layer/GPIO/../Std_Libiraries.h"
...
# 1 "ECU_Layer/Seven_Segment/../../MCAL_Layer/GPIO/../Compilar.h" 1
# 12 "ECU_Layer/Seven_Segment/../../MCAL_Layer/GPIO/../Compilar.h"
...
# 12 "ECU_Layer/Seven_Segment/../../MCAL_Layer/GPIO/../Compilar.h" 2
...
# 1 "ECU_Layer/Seven_Segment/../../MCAL_Layer/GPIO/HAL_GPIO_Config.h" 1
...
Std_ReturnType SEGMENT_Init (const segment_config_t *segment){
    ...
    if ( ((void*)0) == segment ){
        ...
        GPIO_PIN_Init(&(segment->segment_pin[0]));
        GPIO_PIN_Init(&(segment->segment_pin[1]));
        GPIO_PIN_Init(&(segment->segment_pin[2]));
        GPIO_PIN_Init(&(segment->segment_pin[3]));
    }
    return RET;
}
