...
# 12 "ECU_Layer/KeyPad/../../MCAL_Layer/GPIO/../Std_Libiraries.h"
...
# 12 "ECU_Layer/KeyPad/../../MCAL_Layer/GPIO/../Std_Libiraries.h" 2
# 13 "ECU_Layer/KeyPad/../../MCAL_Layer/GPIO/../MCAL_Std_Types.h" 2

# 1 "ECU_Layer/KeyPad/../../MCAL_Layer/GPIO/../Compilar.h" 1
# 12 "ECU_Layer/KeyPad/../../MCAL_Layer/GPIO/../Compilar.h"
...
# 12 "ECU_Layer/KeyPad/../../MCAL_Layer/GPIO/../Compilar.h" 2
...
const static uint8 Keypad_Elements [4] [4] = {7 , 8 , 9 , '/' ,
                                                                         4 , 5 , 6 , '*' ,
                                                                         1 , 2 , 3 , '-' ,
                                                                         'C' , 0 , '=' , '+' };
...
Std_ReturnType KEYPAD_Get_Number (const keypad_config_t *keypad , uint8 *number){
    ...
    if ( ((void*)0) == keypad || ((void*)0) == number){
        RET = (Std_ReturnType)0x00;
    }
    else {
        for ( row_counter=0 ; row_counter<4 ; row_counter++){
