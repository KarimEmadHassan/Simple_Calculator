...
# 12 "MCAL_Layer/ADC/../Std_Libiraries.h"
...
# 1 "MCAL_Layer/ADC/../Compilar.h" 1
# 12 "MCAL_Layer/ADC/../Compilar.h"
...
# 12 "MCAL_Layer/ADC/../Compilar.h" 2
...
# 12 "MCAL_Layer/ADC/../Interrupt/INT_Internal.h"
# 1 "MCAL_Layer/ADC/../Interrupt/INT_Config.h" 1
# 14 "MCAL_Layer/ADC/../Interrupt/INT_Config.h"
# 1 "MCAL_Layer/ADC/../Interrupt/INT_Config_Gen.h" 1
# 14 "MCAL_Layer/ADC/../Interrupt/INT_Config.h" 2
# 47 "MCAL_Layer/ADC/../Interrupt/INT_Config.h"
typedef enum {
    Low_Priorty=0,
    High_Priorty
}interrupt_priority;
# 12 "MCAL_Layer/ADC/../Interrupt/INT_Internal.h" 2
...
# 206 "MCAL_Layer/ADC/ADC.c"
static void ADC_Channel_Config (const ADC_Channel_t channel){
    switch (channel){
        case (ADC_CHANNEL_0): (TRISA |= (1<<0x0)); break;
        case (ADC_CHANNEL_1): (TRISA |= (1<<0x1)); break;
        case (ADC_CHANNEL_2): (TRISA |= (1<<0x2)); break;
        case (ADC_CHANNEL_3): (TRISA |= (1<<0x3)); break;
        case (ADC_CHANNEL_4): (TRISA |= (1<<0x5)); break;
        case (ADC_CHANNEL_5): (TRISE |= (1<<0x0)); break;
        case (ADC_CHANNEL_6): (TRISE |= (1<<0x1)); break;
        case (ADC_CHANNEL_7): (TRISE |= (1<<0x2)); break;
        case (ADC_CHANNEL_8): (TRISB |= (1<<0x2)); break;
        case (ADC_CHANNEL_9): (TRISB |= (1<<0x3)); break;
        case (ADC_CHANNEL_10): (TRISB |= (1<<0x1)); break;
        case (ADC_CHANNEL_11): (TRISB |= (1<<0x4)); break;
        case (ADC_CHANNEL_12): (TRISB |= (1<<0x0)); break;
        default : ;
    }
}
...
static void ADC_Reference_Config (const adc_config_t *adc){
    if ( adc->volt_ref == 1){
        do {ADCON1bits.VCFG1 = 1; ADCON1bits.VCFG1 = 1; }while (0);
    }
    else if ( adc->volt_ref == 0){
        do {ADCON1bits.VCFG1 = 0; ADCON1bits.VCFG1 = 0; }while (0);
    }
    else {
        do {ADCON1bits.VCFG1 = 0; ADCON1bits.VCFG1 = 0; }while (0);
    }
