...
# 12 "ECU_Layer/Relay/../../MCAL_Layer/GPIO/../Std_Libiraries.h"
...
# 1 "ECU_Layer/Relay/../../MCAL_Layer/GPIO/../Compilar.h" 1
# 12 "ECU_Layer/Relay/../../MCAL_Layer/GPIO/../Compilar.h"
...
# 12 "ECU_Layer/Relay/../../MCAL_Layer/GPIO/../Compilar.h" 2
...
Std_ReturnType RELAY_Init (const relay_config_t *relay){
    ...
    if ( ((void*)0) == relay ){
        ...
        pin_config_t relay_info = { .PORT = relay->port , .PIN_NUMBER = relay->pin , .LOGIC = relay->status , .DIRECTION = OUTPUT};
        RET = GPIO_PIN_Init(&relay_info);
    }
    return RET;
}
...
Std_ReturnType RELAY_Turn_ON (const relay_config_t *relay){
    ...
    if ( ((void*)0) == relay ){
        ...
        pin_config_t relay_info = { .PORT = relay->port , .PIN_NUMBER = relay->pin , .LOGIC = relay->status , .DIRECTION = OUTPUT};
        RET = GPIO_PIN_Write_Logic(&relay_info , HIGH);
    }
    return RET;
}
...
Std_ReturnType RELAY_Turn_OFF (const relay_config_t *relay){
    ...
    if ( ((void*)0) == relay ){
        ...
        pin_config_t relay_info = { .PORT = relay->port , .PIN_NUMBER = relay->pin , .LOGIC = relay->status , .DIRECTION = OUTPUT};
        RET = GPIO_PIN_Write_Logic(&relay_info , LOW);
    }
    return RET;
}
...
Std_ReturnType RELAY_Toggle (const relay_config_t *relay){
    ...
    if ( ((void*)0) == relay ){
        ...
        pin_config_t relay_info = { .PORT = relay->port , .PIN_NUMBER = relay->pin , .LOGIC = relay->status , .DIRECTION = OUTPUT};
        RET = GPIO_PIN_Toggle_Logic(&relay_info);
    }
    return RET;
}
