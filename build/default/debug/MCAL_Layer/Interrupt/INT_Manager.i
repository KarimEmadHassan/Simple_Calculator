# 1 "MCAL_Layer/Interrupt/INT_Manager.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "MCAL_Layer/Interrupt/INT_Manager.c" 2
# 1 "MCAL_Layer/Interrupt/INT_Manager.h" 1
# 12 "MCAL_Layer/Interrupt/INT_Manager.h"
# 1 "MCAL_Layer/Interrupt/INT_Config.h" 1
# 12 "MCAL_Layer/Interrupt/INT_Config.h"
...
# 12 "MCAL_Layer/Interrupt/INT_Config.h" 2
...
# 12 "MCAL_Layer/Interrupt/../Std_Libiraries.h"
...
# 1 "MCAL_Layer/Interrupt/../Compilar.h" 1
# 12 "MCAL_Layer/Interrupt/../Compilar.h"
...
# 12 "MCAL_Layer/Interrupt/../Compilar.h" 2
...
# 13 "MCAL_Layer/Interrupt/INT_Config.h" 2
...
# 12 "MCAL_Layer/Interrupt/INT_Manager.h" 2
# 21 "MCAL_Layer/Interrupt/INT_Manager.h"
void INT0_ISR (void);
void INT1_ISR (void);
void INT2_ISR (void);
...
# 31 "MCAL_Layer/Interrupt/INT_Manager.c"
void __attribute__((picinterrupt(("")))) InterruptManager(void){
    ...
    if ( (INTCONbits.RBIE == 1) && (INTCONbits.RBIF == 1) && (PORTBbits.RB4)==0x01 && RB4_flag == 1){
        RB4_flag = 0;
        RB4_ISR(0);
    }
    else{}

    if ( (INTCONbits.RBIE == 1) && (INTCONbits.RBIF == 1) && (PORTBbits.RB4)==0x00 && RB4_flag == 0){
        RB4_flag = 1;
        RB4_ISR(1);
    }
    else{}
    ...
    if ( (INTCONbits.RBIE == 1) && (INTCONbits.RBIF == 1) && (PORTBbits.RB5)==0x01 && RB5_flag == 1){
        RB5_flag = 0;
        RB5_ISR(0);
    }
    else{}

    if ( (INTCONbits.RBIE == 1) && (INTCONbits.RBIF == 1) && (PORTBbits.RB5)==0x00 && RB5_flag == 0){
        RB5_flag = 1;
        RB5_ISR(1);
    }
    else{}

    if ( (INTCONbits.RBIE == 1) && (INTCONbits.RBIF == 1) && (PORTBbits.RB6)==0x01 && RB6_flag == 1){
        RB6_flag = 0;
        RB6_ISR(0);
    }
    else{}

    if ( (INTCONbits.RBIE == 1) && (INTCONbits.RBIF == 1) && (PORTBbits.RB6)==0x00 && RB6_flag == 0){
        RB6_flag = 1;
        RB6_ISR(1);
    }
    else{}

    if ( (INTCONbits.RBIE == 1) && (INTCONbits.RBIF == 1) && (PORTBbits.RB7)==0x01 && RB7_flag == 1){
        RB7_flag = 0;
        RB7_ISR(0);
    }
    else{}

    if ( (INTCONbits.RBIE == 1) && (INTCONbits.RBIF == 1) && (PORTBbits.RB7)==0x00 && RB7_flag == 0){
        RB7_flag = 1;
        RB7_ISR(1);
    }
    else{}
# 105 "MCAL_Layer/Interrupt/INT_Manager.c"
}
