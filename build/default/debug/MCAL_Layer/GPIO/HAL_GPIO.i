...
# 12 "MCAL_Layer/GPIO/../Std_Libiraries.h"
...
# 1 "MCAL_Layer/GPIO/../Compilar.h" 1
# 12 "MCAL_Layer/GPIO/../Compilar.h"
...
# 12 "MCAL_Layer/GPIO/../Compilar.h" 2
...
Std_ReturnType GPIO_PIN_Direction_Init (const pin_config_t *_pin_config){
    ...
    if ( ((void*)0) == _pin_config || (_pin_config->PIN_NUMBER)>8 -1 ){
        ...
        switch(_pin_config->DIRECTION){
            case (OUTPUT):
                (*TRIS_REG[_pin_config->PORT] &= ~(1<<_pin_config->PIN_NUMBER));
                break;
            case (INPUT):
                (*TRIS_REG[_pin_config->PORT] |= (1<<_pin_config->PIN_NUMBER));
                break;
...
Std_ReturnType GPIO_PIN_Direction_Status (const pin_config_t *_pin_config , direction_t *direction_status){
    Std_ReturnType RET = (Std_ReturnType)0x01;
    if ( ((void*)0) == _pin_config || ((void*)0)== direction_status ||(_pin_config->PIN_NUMBER)>8 -1 || (_pin_config->PORT)>5 -1){
        RET = (Std_ReturnType)0x00;
    }

    else{
        *direction_status = ((*TRIS_REG[_pin_config->PORT] >> _pin_config->DIRECTION)&1);
    }
    return RET;
}
...
Std_ReturnType GPIO_PIN_Write_Logic (const pin_config_t *_pin_config , logic_t logic_status){
    Std_ReturnType RET = (Std_ReturnType)0x01;
    if ( ((void*)0) == _pin_config ||(_pin_config->PIN_NUMBER)>8 -1 || (_pin_config->PORT)>5 -1){
        RET = (Std_ReturnType)0x00;
    }
        ...
        switch (logic_status){
            case (HIGH):
                (*LAT_REG[_pin_config->PORT] |= (1<<_pin_config->PIN_NUMBER));
                break;
            case (LOW):
                (*LAT_REG[_pin_config->PORT] &= ~(1<<_pin_config->PIN_NUMBER));
                break;
...
Std_ReturnType GPIO_PIN_Read_Logic (const pin_config_t *_pin_config , logic_t *logic_status){
    Std_ReturnType RET = (Std_ReturnType)0x01;
    if ( ((void*)0) == _pin_config || ((void*)0) == logic_status || (_pin_config->PIN_NUMBER)>8 -1 || (_pin_config->PORT)>5 -1){
        RET = (Std_ReturnType)0x00;
    }

    else{
        *logic_status = ((*PORT_REG[_pin_config->PORT] >> _pin_config->PIN_NUMBER)&1);
    }
    return RET;
}
