...
# 12 "ECU_Layer/DC_Motor/../../MCAL_Layer/GPIO/../Std_Libiraries.h"
...
# 1 "ECU_Layer/DC_Motor/../../MCAL_Layer/GPIO/../Compilar.h" 1
# 12 "ECU_Layer/DC_Motor/../../MCAL_Layer/GPIO/../Compilar.h"
...
# 12 "ECU_Layer/DC_Motor/../../MCAL_Layer/GPIO/../Compilar.h" 2
...
static pin_config_t pin1;
static pin_config_t pin2;
...
Std_ReturnType DC_MOTOR_Init (const motor_pin_t *motor){
    ...
    if ( ((void*)0) == motor ){
        ...
        RET = GPIO_PIN_Init(&(motor->dc_motor[0]));
        RET = GPIO_PIN_Init(&(motor->dc_motor[1]));
    }
    return RET;
}
